...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelClose.setFont(new java.awt.Font("Vineta BT", 0, 18)); // NOI18N
        ...
        jLabelMin.setFont(new java.awt.Font("Vineta BT", 0, 36)); // NOI18N
        jLabelMin.setText("-");
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        String query = "SELECT * FROM `the_users` WHERE `u_uname` = ? and `u_pass` = ?";
        ...
        try {
            ...
            if(rs.next())
            {
                guisdp gdp = new guisdp();
                gdp.setVisible(true);
                gdp.pack();
                gdp.setLocationRelativeTo(null);
